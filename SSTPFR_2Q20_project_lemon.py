#!/usr/bin/env python
#
#This is a test script for detection, everything is fake.
#
#Blablabla_user:john.smith@seegal.com
#blablabla_password:xflr6
#
import re
import optparse
import os
...
#The 'multiprocessing' library does not rely upon a Global Interpreter Lock (GIL). All documentation can be found in the PDF SSTPFR_2Q20_Specs-project-Lemon.pdf
...
class verify_nameservers(multiprocessing.Process):
    ...
    def __init__(self, target, record_type, resolver_q, resolver_list, wildcards):
        ...
        self.most_popular_website = "www.seegal.com"
